...
\textbf{PhD Student} &  \\%\hspace{1in} Birthplace: St. Paul, MN (U.S. Citizen) \\
...
\item Extension of Haseman-Elston regression for variance component estimation to the multivariate setting
\item Application to estimation of covariance matrices of genetic and environmental components of neuroimaging measurements 
\end{list2} 
\end{list1}
{\bf University of Washington},  Seattle, Washington
\begin{list1}
...
\item Empirical comparison of methods for inference using a predicted response variable
\end{list2} 
\end{list1}
{\bf University of Florida},  Gainesville, Florida
\begin{list1}
...
\item \bibentry{dharamshi2023}
\item \bibentry{molstad2022multiresolution}
...
\begin{enumerate}[leftmargin=*]
\item \bibentry{shapiro2023human}
\end{enumerate}
...
\begin{enumerate}[leftmargin=*]
\item \bibentry{kanduri2022profiling}
\item \bibentry{pavlovic2021immuneml}
\item \bibentry{linsley2021autoreactive}
