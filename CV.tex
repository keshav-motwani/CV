...
\begin{list1}
\item[] Research Facilitator, July 2018--August 2018
\begin{list2}
\vspace*{.05in}
...
\section{\sc Skills}
{\bf Advanced:} R, LaTeX\\
{\bf Intermediate:} C++, Bash\\
{\bf Basic:} Python, MATLAB, Mathematica, Excel, Stata, HTML
...
\item UW Statistics Department Admissions Committee member (2018)
