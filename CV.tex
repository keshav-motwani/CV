...
\usepackage{xstring}
\def\FormatName#1{%
  \IfSubStr{#1}{105}{[105 others, including \textbf{Bryan D Martin}]}{\IfSubStr{#1}{Bryan}{\textbf{#1}}{#1}}%
}
...
2020 & Dorothy M. Gilford Excellence in Teaching Award\\
...
\begin{list2}
\vspace*{.05in}
\item Reviewer for \textit{Molecular Ecology}, \textit{Microbiome}, and \textit{Frontiers in Genetics}
...
\item UW Statistics Department Fun Committee co-founder and member (2018--present)
\item UW Statistics Department Admissions Screening Committee (2018, 2019, 2020)
